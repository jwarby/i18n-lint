...
I18nLint.scan = function(lines, options) {
   ...
   * header)
   * another @hack: if template delimited-content is preceded by '=' it will also
   * be removed - this is not to leave attributes without a value. E.g. 'title={test}'
   * needs to be converted to 'title', and not 'title='
   */
